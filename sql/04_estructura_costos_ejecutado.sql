/* PROPÓSITO: Desglosar en qué se va el gasto del año por categoría,
   ...
   (aquí: fertilizantes, deuda vieja) para enfocar la gestión de costos. */
/* ============================================================
...
-- Query 1: % de cada categoría sobre el egreso total del año
SELECT
    categoria,
...
--------------------------------------------------------------------------------
-- Query 2: Estructura de costos AGRUPADA: top categorías + resto en "Otros menores"
